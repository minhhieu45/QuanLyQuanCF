...
(
	...
	DisplayName NVARCHAR(100) NOT NULL DEFAULT N'MinhHieu',
...
INSERT dbo.Food
        ( name, idCategory, price )
VALUES  ( N'Thái xanh', 2, 25000)
INSERT dbo.Food
        ( name, idCategory, price )
VALUES  ( N'Truyền thống', 2, 25000)
INSERT dbo.Food
        ( name, idCategory, price )
VALUES  ( N'Cà phê đen', 3, 15000)
INSERT dbo.Food
        ( name, idCategory, price )
VALUES  ( N'Cà phê sữa', 3, 15000)
