...
namespace QuanLyQuanCafe
{
    public partial class fTableManager : Form
    {
        ...
        void ShowBill(int id)
        {
            ...
            float total = 0;
            foreach (QuanLyQuanCafe.DTO.Menu billInfo in listBillInfo)
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string txtTotalTam = txtTotalPrice.Text.Split(',')[0].ToString();
            double totalPrice = Double.Parse(Regex.Replace(txtTotalTam, @"[^a-zA-Z0-9]", string.Empty));
